            ...
            if oxygen.element == "O" and pdb.number_of_neighors_of_element(oxygen_index, "C") == 2 and oxygen.number_of_neighbors() == 2:
                ...
                if carbon2_index in carbon1.indecies_of_atoms_connecting and carbon1_index in carbon2.indecies_of_atoms_connecting: # so they are connected
                    ...
                    if temp_pdb.in_same_ring(carbon1_index, carbon2_index) == "FALSE":
                        ...
                        if len(carbon1_neighbors) == 2 and len(carbon2_neighbors) == 2:
...
class OperatorsReact:
    ...
    def __epoxide_alcohol(self, pdb1, pdb2, reaction, chiral_choice, hydroxyl_side_choice): # this actually accounts for alcohol and thiol # This has been updated
        ...
        intermediate.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'intermediate3.pdb')
        
        # okay, now let's load in the hydroxyl group
        hydroxyl = pymolecule.Molecule()
        hydroxyl.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'intermediate5.pdb')
        ...
        if nucleophile_heteroatom == "O":
            ether_intermediate.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'intermediate4.pdb')
        elif nucleophile_heteroatom == "S":
            ether_intermediate.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'intermediate7.pdb')
    ...
    def __alkene_to_epoxide(self, pdb1, reaction, chiral_choice):
        ...
        intermediate = pymolecule.Molecule()
        intermediate.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'generic_epoxide.pdb')
    ...
    def __sulfonyl_azide_thio_acid(self, pdb1, pdb2, reaction, cis_or_trans): # sulfonyl_azide - thio acid reactions
        ...
        intermediate = pymolecule.Molecule()
        if cis_or_trans == 0:
            intermediate.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'intermediate2.pdb')
        else:
            intermediate.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'intermediate2_isomer.pdb')
    ...
    def __alkyne_azide(self, pdb1, pdb2, reaction, orientation_choice): # Azide alkyne Huisgen cycloaddition reactions
        ...
        intermediate = pymolecule.Molecule()
        intermediate.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'intermediate1.pdb')
    ...
    def __primary_amine_to_azide_or_NCO_or_NCS(self, pdb1, reaction, choice):
        ...
        if choice == 0:
            azide.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'intermediate9.pdb')
        elif choice == 1:
            azide.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'N-C-O.pdb')
        elif choice == 2:
            azide.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'N-C-S.pdb')
    ...
    def __azide_to_primary_amine(self, pdb1, reaction, charge_choice):
        ...
        if charge_choice == 0:
            ...
            if pdb1.hybridization(azide_X_index) == 3:
                amine.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'intermediate10.pdb')
            else: # so it must be bound to an sp2 hybridized atom
                amine.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'sp2_primary_amine.pdb')
                sp2 = 'YES'
        else:
            amine.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'charged_amine.pdb')
    ...
    def __carbonochloridate_amine(self, pdb1, pdb2, reaction, cis_or_trans_choice): # Note that pdb2 can be a primary or secondary amine
        ...
        intermediate = pymolecule.Molecule()
        intermediate.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'carbamate.pdb')
    ...
    def __carboxylate_amine(self, pdb1, pdb2, reaction, cis_or_trans_choice): # Note that pdb2 can be a primary or secondary amine
        ...
        intermediate = pymolecule.Molecule()
        intermediate.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'amide.pdb')
    ...
    def __carboxylate_alcohol(self, pdb1, pdb2, reaction): # This covers thiols and alcohols
        ...
        intermediate = pymolecule.Molecule()
        if (reaction[4] == "O"):
            intermediate.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'carboxylic_acid.pdb')
        else:
            intermediate.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'thio_acid.pdb')
    ...
    def isocyanate_amine(self, pdb1, pdb2, reaction, amide_cis_or_trans_choice, nucleophile_amine_cis_or_trans_choice): # Note that pdb2 can be a primary or secondary amine. Note that this also works for isothiocyanates
        ...
        if amide_cis_or_trans_choice == 0: # so cis
            if element == "O": # so urea
                intermediate.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'urea_cis.pdb')
            else: # so thiourea
                intermediate.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'thiourea_cis.pdb')
        else: # so trans
            if element == "O": # so urea
                intermediate.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'urea_trans.pdb')
            else: # so thiourea
                intermediate.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'thiourea_trans.pdb')
        ...
        if amide_cis_or_trans_choice == 0: # so cis
            if isocyanate_element == "O": # so carbonyl
                if alcohol_element == "O": # so alcohol
                    ...
                    intermediate.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'carbamate_2_cis.pdb')
                else: # so thiol
                    # cis, carbonyl, thiol
                    intermediate.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'carbamothioate_2_cis.pdb')
            else: # so thiocarbonyl
                if alcohol_element == "O": # so alcohol
                    # cis, thiocarbonyl, alcohol
                    intermediate.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'carbamothioate_1_cis.pdb')
                else: # so thiol
                    # cis, thiocarbonyl, thiol
                    intermediate.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'carbamodithioate_cis.pdb')
        else: # so trans
            if isocyanate_element == "O": # so carbonyl
                if alcohol_element == "O": # so alcohol
                    # trans, carbonyl, alcohol
                    intermediate.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'carbamate_2_trans.pdb')
                else: # so thiol
                    # trans, carbonyl, thiol
                    intermediate.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'carbamothioate_2_trans.pdb')
            else: # so thiocarbonyl
                if alcohol_element == "O": # so alcohol
                    # trans, thiocarbonyl, alcohol
                    intermediate.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'carbamothioate_1_trans.pdb')
                else: # so thiol
                    # trans, thiocarbonyl, thiol
                    intermediate.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'carbamodithioate_trans.pdb')
    ...
    def __tertiary_or_primary_halide_to_azide(self, pdb1, reaction, cyanide_or_azide): # This works for tertiary_or_primary_halides. These are the ones that have no inversions of their stereocenters.
        ...
        if cyanide_or_azide == 0:
            intermediate.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'intermediate9.pdb')
        elif cyanide_or_azide == 1:
            intermediate.load_pdb('.' + os.sep + 'intermediates.tmp' + os.sep + 'cyanide.pdb')
...
class AutoClickChem:
    ...
    def __init__(self):
        ...
        if not os.path.exists("." + os.sep + "intermediates.tmp"):
            os.mkdir("." + os.sep + "intermediates.tmp")
    ...
    def __make_intermediates(self):
        ...
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'amide.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'carbamate_2_cis.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'carbamate_2_trans.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'carbamate.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'carbamodithioate_cis.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'carbamodithioate_trans.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'carbamothioate_1_cis.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'carbamothioate_1_trans.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'carbamothioate_2_cis.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'carbamothioate_2_trans.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'carboxylic_acid.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'charged_amine.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'cyanide.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'generic_epoxide.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'intermediate10.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'intermediate1.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'intermediate2_isomer.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'intermediate2.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'intermediate3.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'intermediate4.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'intermediate5.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'intermediate6.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'intermediate7.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'intermediate8.pdb','w')
        f.write("HETATM    1  C1          0      -6.421   3.387   0.000  1.00  0.00           C" + "\n")
        f.write("HETATM    2  H2          0      -5.563   4.075   0.000  1.00  0.00           H" + "\n")
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'intermediate9.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'N-C-O.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'N-C-S.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'sp2_primary_amine.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'thio_acid.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'thiourea_cis.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'thiourea_trans.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'urea_cis.pdb','w')
        ...
        f.close()
        f = open('.' + os.sep + 'intermediates.tmp' + os.sep + 'urea_trans.pdb','w')
    ...
    def __get_pdb_files(self, loc, log):
        ...
        if os.path.isdir(loc): # so it's a directory, go through the directory and find all the pdb files
            ...
            if loc[-3:]=="PDB" or loc[-3:]=="pdb":
                ...
                self.__log_file_output("The file " + loc + " does not have the PDB file extention and so cannot be used.",log)
        return files
    ...
    def start(self):
        ...
        for index in range(1,len(args)):
            ...
            if arg.lower()=="-reactants1":
                loc = args[index + 1]
                reactants1.extend(self.__get_pdb_files(loc,log)) # so it's a directory
                required_input1 = True
                args[index] = ""
                args[index + 1] = ""
            elif arg.lower()=="-reactants2":
                loc = args[index + 1]
                reactants2.extend(self.__get_pdb_files(loc,log)) # so it's a directory
        ...
        shutil.rmtree("." + os.sep + "intermediates.tmp")
